...
namespace JWTRefreshToken.Extension
{
    public static partial class ApplicationService
    {
        ...
        {
            // Configure Identity options. The actual AddIdentity is called in Program.cs to register
            // Identity with the ApplicationUser and IdentityRole types.
